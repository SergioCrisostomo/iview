...
<script>
    ...
    const prefixCls = 'ivu-infinite-scroll';
    ...
    export default {
        ...
        data() {
            return {
                ...
                touchScroll: false,
                handleScroll: throttle(this.onScroll, 150, {leading: false}),
                pointerUpHandler: this.onPointerUp.bind(this), // because we need the same function to add and remove event hadlers
                pointerMoveHandler: throttle(this.onPointerMove, 50, {leading: false}) // because we need the same function to add and remove event hadlers
            };
        },
        computed: {
            wrapClasses() {
        ...
        methods: {
            ...
            reset() {
                ...
                if (this.touchScroll) {
                    setTimeout(() => {
                        ...
                        this.$refs.scrollContainer.removeEventListener(handlers.pointermove, this.pointerMoveHandler);
            ...
            onScroll() {
                ...
                if (scrollDirection == -1 && displacement <= this.sensitivity) {
            ...
            onPointerDown(e) {
                ...
                if (e.type == 'mousedown' || this.isLoading) return;
                ...
                this.$refs.scrollContainer.parentElement.addEventListener(handlers.pointermove, e => {
                    e.stopPropagation();
            ...
            onPointerMove(e) {
                ...
                if (!this.touchScroll) {
                    const wasDragged = Math.abs(yDiff) > this.minimumStartDragOffset;
